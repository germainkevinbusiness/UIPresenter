...
interface PresenterAnimation {
     ...
     * @param presenter The Presenter is the [View] which presents your UI and the [View] that your
     * custom animation will animate.
     ...
     * from the [presenter] to the [UIPresenter], making it impossible for this library and you,
     * to remove the [presenter]
     * */
    fun runAnimation(
